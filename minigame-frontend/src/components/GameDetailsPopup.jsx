...
export default function GameDetailsPopUp({ game, toggleDisplay }) {
  return (
    <div>
      <div className="fixed inset-0 bg-black opacity-50 z-10" onClick={toggleDisplay}></div>
      <div className="fixed flex flex-col bg-gray-300 shadow-md rounded-xl h-[70%] md:h-[60%] lg:h-[60%]     w-[80%] md:w-[75%] lg:w-[60%]    z-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
        <p className=" text-2xl pl-[3.5%]  font-semibold ">{game.gameName}</p>
